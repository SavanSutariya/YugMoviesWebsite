              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    while ($row = mysqli_fetch_assoc($user_results)){
                      if ($row['readed'] == 0) {
                        $badge = "<span class='badge badge-pill badge-info'>New</span>";
                      }
                      else {
                        $badge ="";
                      }
                ...
                <tr>
                  ...
                  <td>'.$row['timestamp'].'</td>
                  <td><a href="mailto:'.$row['email'].'"><button type="submit" class="btn btn-primary">Replay</button></a></td>
                </tr>';
                    }
                ?>
                </tbody>
...
<?php
   $readedqry = "UPDATE `contact` SET `readed`=1";
   $marked = mysqli_query($conn,$readedqry);
?>